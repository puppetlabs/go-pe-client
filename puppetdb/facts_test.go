...
func TestFactNames(t *testing.T) {
	// Test FactNames
	setupGetResponder(t, "/pdb/query/v4/fact-names", "", "factnames-response.json")
...
func TestFacts(t *testing.T) {
	...
	setupGetResponder(t, "/pdb/query/v4/facts", "query="+query, "facts-response.json")
